    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nama_barang', models.ForeignKey(related_name='barang_diskon', to='monarchy.Barang')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nama_barang', models.ForeignKey(related_name='barang_stok', to='monarchy.Barang')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('harga_satuan', models.ForeignKey(to='monarchy.Stok')),
                ('nama_barang', models.ForeignKey(related_name='barang_transaksi', to='monarchy.Barang')),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='barang',
            name='perusahaan',
            field=models.ForeignKey(related_name='asal', to='monarchy.Perusahaan'),
