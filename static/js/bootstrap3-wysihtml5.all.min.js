	...
	a.Selection = Base.extend({
		...
		scrollIntoView: function() {
			...
			if ((b = c._wysihtml5ScrollIntoViewElement) || (b = c.createElement("span"), b.innerHTML = a.INVISIBLE_SPACE), b = c._wysihtml5ScrollIntoViewElement = b, d) {
				...
				var d = b,
					e = 0;
				if (d.parentNode) do e += d.offsetTop || 0, d = d.offsetParent;
				while (d);
			...
			function d(a) {
				a.registerHelper("helperMissing", function(a) {
					...
					var c, d = b.fn,
						...
						f = 0,
						g = "";
					if (m(a) && (a = a.call(this)), b.data && (c = q(b.data)), a && "object" == typeof a) if (l(a)) for (var h = a.length; h > f; f++) c && (c.index = f, c.first = 0 === f, c.last = f === a.length - 1), g += d(a[f], {
						data: c
					});
					else for (var i in a) a.hasOwnProperty(i) && (c && (c.key = i), g += d(a[i], {
						data: c
					}), f++);
